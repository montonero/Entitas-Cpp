...
{
    return TriggerOnEvent(*this, GroupEventType::Added);
}

auto Matcher::onEntityRemoved() -> const TriggerOnEvent
{
    return TriggerOnEvent(*this, GroupEventType::Removed);
}

auto Matcher::onEntityAddedOrRemoved() -> const TriggerOnEvent
{
    return TriggerOnEvent(*this, GroupEventType::AddedOrRemoved);
}
